...
api_url_base = "https://SEPM Server:8446/sepm/api/v1/"
authentication_url = "https://SEPM Server:8446/sepm/api/v1/identity/authenticate"
# if output is required in JSON format
json_format = True

payload = {"username" : "SEPM admin", "password" : "SEPM Password","domain" : "SEPM Domain"}
